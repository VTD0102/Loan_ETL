...
`etl/` holds the Bronze -> Silver -> Core -> Gold pipeline. `ml/` contains training and prediction utilities. `database/` stores SQL init and transform scripts. `docs/` contains architecture notes, data dictionaries, and guides.
