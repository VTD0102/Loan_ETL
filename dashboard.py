...
def render_dashboard(df_gold):
    ...
    df_table_display = df_table[cols_to_show].rename(columns={
        'listing_key': 'ID', 'employment_status': 'Employment', 'occupation': 'Occupation', 
        'credit_score_midpoint': 'FICO Mid', 'stated_monthly_income': 'Monthly Inc ($)', 
        'loan_original_amount': 'Loan Amt ($)', 'is_default': 'Default (1=Yes)'
    })
