...
- `etl_*.py`: Scripts ETL cho từng lớp (load_bronze.py, etl_silver.py, etl_gold.py, etl_core.py).
...
- `md_files/`: Tài liệu chi tiết về data dictionary và ML.
...
5. **Khởi chạy App:** Sử dụng `streamlit run app.py` để launch hệ thống.
